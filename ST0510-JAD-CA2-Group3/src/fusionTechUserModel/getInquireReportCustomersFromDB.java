...
public class getInquireReportCustomersFromDB implements Serializable {
	public ArrayList<UserDetails> inquireCustomers(String tableType, String sqlConnUrl) {
		...
		try {
			...
			case "PostalCode":
				sqlStr = "SELECT * FROM Users\r\n" + 
						...
						" ORDER BY Country, State, PostalCode, Users.ID asc";
				break;
			case "Admins":
				sqlStr = "SELECT * FROM Users\r\n" + 
						" INNER JOIN userroles ON userroles.ID = UserType \r\n" + 
			...
			ResultSet users = stmt.executeQuery(sqlStr);
