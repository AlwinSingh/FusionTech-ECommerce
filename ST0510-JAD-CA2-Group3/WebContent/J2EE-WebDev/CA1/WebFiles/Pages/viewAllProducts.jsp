...
<body>
	...
	<div class="jumbotron jumbotron-fluid"
		...
		<div class="container">
			<h1 class="display-4 mt-3 text-light">All Products</h1>
			<p class="text-light">You are currently viewing all products</p>
		</div>
	</div>

	<div class="container mt-5 mb-5">
		<form action="viewProduct.jsp" method="GET" class="col-12">
			<div class="row">
				...
				<%
					...
					if (session.getAttribute("productList") != null) {
				        ...
				        //productList = (ArrayList<allProducts>) request.getServletContext().getAttribute("productListAppScope");\
						...
						response.sendRedirect("../../../../getAllProducts?getProductLineID=0&getProductLineName=All Products");
					}
					
					for (int i = 0; i < productList.size(); i++) {
						if (productList.get(i).getProductisAvailable() == 1) {
				%>
					...
					<figure class="card card-product"
						...
						<figcaption class="info-wrap text-center">
							<h6 class="title text-dots">
								...
								%>
								<a href="#"><%= productList.get(i).getProductName() %> (Out
									of stock)</a>
								<%
									}
								%>
							...
							<div class="action-wrap">
								...
								<div class="price-wrap h5 mt-2">
									<span class="price-new"><%= productList.get(i).getProductCurrencySymbol() %>
						...
						<hr>
						<p class="text-center pdtDescription p-2"
...
<script>
	$('.productBtnProcess').click(
			function() {
				...
				//Passes the value into the hidden input fields
				//They are not part of the SQL while loop because you are viewing each invidiual product, hence the value must be unique and 
				//it would be easier to handle it via JS as part of optimisation
